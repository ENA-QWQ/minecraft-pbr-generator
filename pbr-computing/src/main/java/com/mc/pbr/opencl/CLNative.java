...
public class CLNative {
    ...
    public static native long createViT(int embedDim, int numLayers, int numHeads, int mlpDim, int seqLen, int inChannels, int patchH, int patchW, int numClasses, long seed, int mppNumClasses);
    public static native long createViTWithWeights(int embedDim, int numLayers, int numHeads, int mlpDim, int seqLen, int inChannels, int patchH, int patchW, int numClasses, float[] weights, float[] biases, int mppNumClasses);
