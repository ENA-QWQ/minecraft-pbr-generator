...
| 参数 | 含义 | 默认值 |
|------|------|--------|
| `-d, --data` | 数据文件 | `train_data.bin` |
| `-l, --labels` | 标签文件 | `train_labels.bin` |
| `-o, --output` | 模型输出路径 | `height_model.ser` |
| `-b, --batch-size` | 批量大小 | `64` |
| `-e, --epochs` | 最大轮数 | `50` |
| `-p, --patience` | 早停耐心 | `8` |
| `-r, --lr` | 初始学习率 | `0.01` |
| `-y, --lr-decay` | 衰减因子 | `0.9` |
| `-s, --lr-step` | 衰减步长 | `10` |
| `-S, --seed` | 随机种子 | `42` |
| `-T, --total-samples` | 总样本数 | `2000000` |
| `-t, --train-size` | 训练集样本数 | `1000000` |
| `-v, --val-size` | 验证集样本数 | `20000` |
| `-h, --help` | 显示帮助 | — |
...
**运行：**
```bash
java -jar pbr-inference-1.0.0.jar -i <输入图片> [选项]
```
**参数：**
...
|------|------|--------|
| `-i, --input` | 输入图片路径 | 必填 |
| `-o, --outputDir` | 输出目录 | `./output` |
| `-m, --model` | 模型路径 | `height_model.ser` |
| `-s, --strength` | 法线强度 | `6.0` |
| `-p, --pixelate` | 像素化开关 | `false` |
| `-sm, --smoothness` | 基础光滑度 | `0.2` |
| `-me, --metallic` | 基础金属度 | `0.0` |
| `-invH, --invert-height` | 反转高度 | `true` |
| `-invN, --invert-normal-y` | 反转法线Y | `false` |
| `-hs, --height-strength` | 高度对比度 | `1.2` |
| `-hmin, --height-min` | 高度最小值 | `0.2` |
| `-hmax, --height-max` | 高度最大值 | `1.0` |
| `-hsm, --height-smooth` | 模糊半径 | `2` |
| `-np, --norm-percentile` | 百分位截断 | `2.0` |
| `-h, --help` | 显示帮助 | — |
...
| Option | Description | Default |
|--------|-------------|---------|
| `-d, --data` | Data file | `train_data.bin` |
| `-l, --labels` | Label file | `train_labels.bin` |
| `-o, --output` | Model output path | `height_model.ser` |
| `-b, --batch-size` | Batch size | `64` |
| `-e, --epochs` | Max epochs | `50` |
| `-p, --patience` | Early stop patience | `8` |
| `-r, --lr` | Initial learning rate | `0.01` |
| `-y, --lr-decay` | Decay factor | `0.9` |
| `-s, --lr-step` | Decay step | `10` |
| `-S, --seed` | Random seed | `42` |
| `-T, --total-samples` | Total samples | `2000000` |
| `-t, --train-size` | Training samples | `1000000` |
| `-v, --val-size` | Validation samples | `20000` |
| `-h, --help` | Show help | — |
...
**Run:**
```bash
java -jar pbr-inference-1.0.0.jar -i <input_image> [options]
```
**Options:**
...
| `-o, --outputDir` | Output directory | `./output` |
| `-m, --model` | Model path | `height_model.ser` |
| `-s, --strength` | Normal strength | `6.0` |
| `-p, --pixelate` | Enable pixelation | `false` |
| `-sm, --smoothness` | Base smoothness | `0.2` |
| `-me, --metallic` | Base metallic | `0.0` |
| `-invH, --invert-height` | Invert height | `true` |
| `-invN, --invert-normal-y` | Invert normal Y | `false` |
| `-hs, --height-strength` | Height contrast | `1.2` |
| `-hmin, --height-min` | Height min | `0.2` |
| `-hmax, --height-max` | Height max | `1.0` |
| `-hsm, --height-smooth` | Blur radius | `2` |
| `-np, --norm-percentile` | Percentile cutoff | `2.0` |
| `-h, --help` | Show help | — |
