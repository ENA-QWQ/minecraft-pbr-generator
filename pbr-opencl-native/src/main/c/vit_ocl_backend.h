...
typedef struct {
    ...
    int num_classes;
    int dec_channels[3];
    int dec_total_weights;
    int dec_total_biases;
    cl_mem d_dec_weights;
    cl_mem d_dec_biases;
    cl_mem d_dec_gradWeights;
    cl_mem d_dec_gradBiases;
    cl_mem d_dec_mWeights;
    cl_mem d_dec_vWeights;
    cl_mem d_dec_mBiases;
    cl_mem d_dec_vBiases;
    cl_mem d_dec_stage1;
    cl_mem d_dec_stage2;
    cl_mem d_dec_stage3;
    cl_mem d_final_output;
    cl_kernel kernel_upsample;
    cl_kernel kernel_conv_offset;
    cl_kernel kernel_conv_backward_offset;
    int initialized;
} VitBackend;
